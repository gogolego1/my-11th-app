...
규칙:
- vark 값은 반드시 "시각형", "청각형", "읽기쓰기형", "운동감각형" 중 하나
...
규칙:
- holland 값은 "탐구형(I)", "예술형(A)", "사회형(S)", "진취형(E)", "현실형(R)", "관습형(C)" 중 하나
- scores 숫자는 따옴표 없이 숫자만
- 점수가 없으면 scores를 {}로""",
...
규칙:
- 각 값은 "높음", "보통", "지원 필요" 중 하나만
- 점수 기준: 80점 이상=높음, 60~79점=보통, 60점 미만=지원 필요
- 키 이름은 정확히 위와 동일하게""",
